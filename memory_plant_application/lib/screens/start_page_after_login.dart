        ...
        body: Stack(
          children: [
            AnimatedPositioned(
              ...
              left: 0,
              right: 0,
              child: PrimaryBox(height: MediaQuery.of(context).size.height * primaryBoxHeight),
            ),
            Center(
              child: Column(
                children: [
...
class _StartPageAfterLoginState extends State<StartPageAfterLogin> {
  ...
  void initState() {
    super.initState();
    _loadUserName();
    _startPrimaryBoxSlideIn();
  }

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    _startPrimaryBoxSlideIn(); // 페이지로 돌아올 때 애니메이션 재실행
  }
  ...
  void _startPrimaryBoxSlideIn() {
    setState(() {
      primaryBoxTopPosition = -250;
    });
    Future.delayed(Duration.zero, () {
      setState(() {
        primaryBoxTopPosition = 0;
  ...
  void _navigateToNextPage() async {
    ...
    _startPrimaryBoxSlideIn(); // 페이지에서 돌아왔을 때 애니메이션 재실행
  }
